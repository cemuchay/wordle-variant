-- ====================================================================
-- SQL Script 135: Streak Milestone Awards Constraint, RLS & Migration
-- ====================================================================

-- Step 1: Purge any previously inserted invalid streak awards
DELETE FROM user_awards WHERE award_type LIKE 'streak_%';

-- Step 2: Ensure user_awards table check constraint allows streak award types
...
-- Step 3: Enable RLS and setup policies for user_awards table
