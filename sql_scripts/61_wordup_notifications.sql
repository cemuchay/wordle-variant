-- 61_wordup_notifications.sql
-- Database trigger to automatically create notifications for WordUp challenges.
-- Runs with SECURITY DEFINER to bypass client-side RLS policies.
