-- 58_fix_message_edit_delete.sql
-- Add missing columns and configure UPDATE policies for message edit/delete features.
...
-- 3. Configure UPDATE policies for public.messages so users can edit or delete their own messages
