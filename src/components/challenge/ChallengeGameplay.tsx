...
export const ChallengeGameplay = memo(({
    ...
    const [state, dispatch] = useReducer(challengeGameReducer, {
        ...
        isGameOver: false // Will be determined by initialization effect
    });
    ...
    useEffect(() => {
        if (isMarathon) {
            ...
            // Regular Fixed Length Challenge
    ...
    const onEnter = useCallback(async () => {
        ...
        if (won || lost) {
            ...
            setTimeout(() => {
                ...
                if (isMarathon) setSelectedLength(null);
                else onFinish();
            }, 2000);
        } else {
            let resultPayload: any;
        ...
        return (
            <div className="flex-1 p-6 flex flex-col gap-8">
                ...
                <div className="mt-auto pt-6 border-t border-white/5 flex items-center justify-between">
                    ...
                    <button onClick={onFinish} className="bg-white/5 border border-white/10 px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-white/10 transition-colors">
                        Exit to Lobby
                    </button>
                </div>
            </div>
