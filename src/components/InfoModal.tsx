          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                Stuck? A hint unlocks after your <span className="text-white font-bold">3rd attempt</span>. Using it marks your result with shame. <span className="text-red-500 font-bold">Locked on the last guess!</span>
              </p>
            </div>
          </div>
        </div>
