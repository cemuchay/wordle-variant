...
export const AppNavigation = ({
    ...
    return (
        <nav className="w-full z-40 bg-dark border-t border-white/10 px-1 py-1.5 sm:self-center sm:mb-4 sm:rounded-2xl sm:border sm:border-white/10 sm:max-w-lg sm:px-6 sm:py-2 sm:shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] transition-all duration-300">
                ...
                {navItems.map((item) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {/* Text label */}
                            <span
                                className={`text-[9px] uppercase font-black tracking-wider transition-colors duration-300 ${
                                    isActive
                                        ? 'text-white'
