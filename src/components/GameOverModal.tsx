...
export const GameOverModal: React.FC<Props> = ({
  ...
  return (
    <ModalLayout isOpen={isOpen} onClose={onClose} maxWidth="lg">
      ...
      <button
        onClick={onClose}
        className="mt-6 text-gray-500 text-xs hover:text-white uppercase tracking-widest transition-colors cursor-pointer"
      >
        Close
      </button>
    </ModalLayout>
