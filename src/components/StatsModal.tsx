  ...
  return (
    ...
    >
      <div className="w-full max-w-xl mx-auto flex flex-col h-full min-h-0 flex-1 relative overflow-hidden">
        <div className="flex items-center justify-between mb-4 shrink-0 px-2 relative">
          <h2 className="text-xl uppercase tracking-tighter text-gray-100 flex-1 text-center font-black">Leaderboard</h2>
          {onClose && (
            <button
              onClick={onClose}
              className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500 hover:text-white hover:bg-white/5 p-1 rounded-full transition-colors cursor-pointer"
              title="Close"
            >
              <X size={20} />
            </button>
    ...
    >
      <div className="flex items-center gap-3">
        <div className="relative">
          ...
          {isFirst && (
            <div className="absolute -top-6 left-8.25 sm:-top-6 sm:left-8.5 text-[18px] w-4.5 flex justify-center select-none">
