...
export const BOT_PROFILES: Record<string, BotProfile> = {
   slow_thinker: { name: "Sloths", accuracy: 0.5, minDelay: 6.0, maxDelay: 9.0 },
   ...
   lagos_boy: { name: "LagosBoy", accuracy: 0.78, minDelay: 3.5, maxDelay: 6.5 },
   jollof_brain: { name: "Jollof", accuracy: 0.8, minDelay: 3.0, maxDelay: 6.0 },
   okada_rider: { name: "Okada", accuracy: 0.82, minDelay: 2.5, maxDelay: 5.5 },
   naija_flash: { name: "Flash", accuracy: 0.95, minDelay: 1, maxDelay: 2 },
   suya_thinker: { name: "Suya", accuracy: 0.74, minDelay: 4.0, maxDelay: 7.0 },
   pepper_soup: { name: "PepperSoup", accuracy: 0.79, minDelay: 3.2, maxDelay: 6.2 },
   agbada_mode: { name: "Agidi", accuracy: 0.83, minDelay: 2.8, maxDelay: 5.8 },
   street_king: { name: "Marlians", accuracy: 0.5, minDelay: 3.0, maxDelay: 5.5 },
   ogbonge_mind: { name: "Shelly", accuracy: 0.9, minDelay: 1.8, maxDelay: 4.0 },
