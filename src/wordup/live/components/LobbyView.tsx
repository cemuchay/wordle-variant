...
import { HelpCircle, ChevronDown, ChevronUp, Loader2, Volume2, VolumeX, Swords, Shuffle, Radio, GraduationCap, LayoutGrid, ChevronRight } from "lucide-react";
      ...
      >
         <div className="space-y-1 relative text-center">
            ...
            <div className="flex items-center justify-between gap-4 px-2 shrink-0">
               <div className="inline-flex items-center gap-2 px-3 py-1.5 mb-2 text-xs font-black uppercase tracking-widest text-[#E85151]">
                        ...
                        {historyMatches.map((match) => {
                           ...
                           return (
                              <div
                                 ...
                                 className={`hover:bg-white/10 rounded-2xl p-3.5 flex items-center justify-between text-xs cursor-pointer active:scale-98 transition-all ${isNew ? "bg-[#E85151]/10 border border-[#E85151]/30 shadow-[0_0_12px_rgba(232,81,81,0.1)] hover:border-[#E85151]/50" : "bg-white/5 border border-white/10 hover:border-white/20"}`}
                              >
                                 <div className="min-w-0">
                                    <div className="flex items-center gap-2">
                                       <p className="font-black text-white truncate">vs {oppName}</p>
                                       {isNew && (
                                          <span className="text-[7.5px] font-black uppercase text-[#E85151] bg-[#E85151]/10 border border-[#E85151]/25 px-1.5 py-0.5 rounded-md tracking-wider animate-pulse">
                                             NEW
                                          </span>
                                       )}
                                    </div>
                                    <p className="text-[9px] text-white/40 font-bold uppercase mt-0.5">{match.category.replace('_', ' ')} • {dateStr}</p>
                                 </div>
