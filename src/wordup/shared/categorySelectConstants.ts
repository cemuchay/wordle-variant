...
> = {
   ...
   bible: {
      ...
      glow: "shadow-[0_0_20px_rgba(245,158,11,0.15)]",
      border: "border-amber-500/50 text-amber-400",
      svg: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1-2.5-2.5Z"/><path d="M6 2v18"/><path d="M12 6v6"/><path d="M10 8h4"/></svg>`,
   },
   "global-politics": {
      emoji: "🌐",
      gradient: "from-blue-950/40 via-slate-900/20 to-emerald-950/40",
      glow: "shadow-[0_0_20px_rgba(59,130,246,0.15)]",
      border: "border-blue-500/50 text-blue-400",
      svg: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/></svg>`,
   },
};
