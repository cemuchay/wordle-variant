 ...
 */
runTest("New System (Win in 2)", calculateSkillIndex({ attempts: 2, maxAttempts: 6, usedHint: false, guesses: winIn2Guesses, targetWord: 'TRACE', gameDate: '2026-05-18' }), 1058);
 ...
 */
runTest("New System (STEEL duplicate logic)", calculateSkillIndex({ attempts: 2, maxAttempts: 6, usedHint: false, guesses: duplicateGuesses, targetWord: 'STEEL', gameDate: '2026-05-18' }), 983);
 ...
 */
runTest("New System (Fail - No Payoff)", calculateSkillIndex({ attempts: 2, maxAttempts: 6, usedHint: false, guesses: lossGuesses, targetWord: 'APPLE', gameDate: '2026-05-18' }), 90);
...
runTest("New System (Win with Hint)", calculateSkillIndex({ attempts: 1, maxAttempts: 6, usedHint: true, guesses: legacyGuesses, targetWord: 'APPLE', gameDate: '2026-05-18', hintRecord: hintRecordWithRow }), 1200);
