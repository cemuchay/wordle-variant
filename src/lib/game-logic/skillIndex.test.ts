...
runTest("Legacy System (Win in 1)", calculateSkillIndex({ attempts: 1, maxAttempts: 6, usedHint: false, guesses: legacyGuesses, gameDate: '2026-05-17' }).finalScore, 1075);
 ...
 */
runTest("New System (Win in 2)", calculateSkillIndex({ attempts: 2, maxAttempts: 6, usedHint: false, guesses: winIn2Guesses, gameDate: '2026-05-18' }).finalScore, 1058);
 ...
 */
runTest("New System (STEEL duplicate logic)", calculateSkillIndex({ attempts: 2, maxAttempts: 6, usedHint: false, guesses: duplicateGuesses, gameDate: '2026-05-18' }).finalScore, 983);
 ...
 */
runTest("New System (Fail - No Payoff)", calculateSkillIndex({ attempts: 2, maxAttempts: 6, usedHint: false, guesses: lossGuesses, gameDate: '2026-05-18' }).finalScore, 90);
...
runTest("New System (Repeat Strategic Mistake)", calculateSkillIndex({ attempts: 2, maxAttempts: 6, usedHint: false, guesses: repeatMistakeGuesses, gameDate: '2026-05-18' }).finalScore, -125);
...
runTest("New System (Win with Hint)", calculateSkillIndex({ attempts: 1, maxAttempts: 6, usedHint: true, guesses: legacyGuesses, gameDate: '2026-05-18', hintRecord: hintRecordWithRow }).finalScore, 1200);
